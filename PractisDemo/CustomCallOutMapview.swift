...
class CustomCallOutMapview: UIViewController,MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        for i in 0...2
        {
            ...
            point.image = UIImage(named: "pin1.png")
            point.name = names[i]
                 ...
                 didSelect view: MKAnnotationView)
    {
        ...
        calloutView.backgroundColor = UIColor.brown
        calloutView.starbucksName.text = starbucksAnnotation.name
        calloutView.starbucksAddress.text = starbucksAnnotation.address
        calloutView.starbucksPhone.text = starbucksAnnotation.phone
        
        let button = UIButton(frame: calloutView.starbucksPhone.frame)
        button.addTarget(self, action: #selector(CustomCallOutMapview.callPhoneNumber(sender:)), for: .touchUpInside)
    ...
    @IBAction func btnCloseAction(_ sender: UIButton) {
        //        AppUtils.removeChildViewController(controller: self)
      //  AppUtils.removeChildViewController(controller: self, controllerTag: nil)
    }
